...
|---|---|---|---|
| adapt_authoring | 3 | A tool for creating and authoring e-learning content | [https://recipes.coopcloud.tech/adapt_authoring](https://recipes.coopcloud.tech/adapt_authoring) |
| agora | 3 | A tool for collaborative deliberation | [https://recipes.coopcloud.tech/agora](https://recipes.coopcloud.tech/agora) |
| alerta | 3 | A monitoring and alerting tool | [https://recipes.coopcloud.tech/alerta](https://recipes.coopcloud.tech/alerta) |
| amusewiki | 3 | A wiki engine with a focus on books and text | [https://recipes.coopcloud.tech/amusewiki](https://recipes.coopcloud.tech/amusewiki) |
| authentik | 3 | An open-source identity provider | [https://recipes.coopcloud.tech/authentik](https://recipes.coopcloud.tech/authentik) |
| babybuddy | 3 | A tracking and monitoring app for babies and young children | [https://recipes.coopcloud.tech/babybuddy](https://recipes.coopcloud.tech/babybuddy) |
| backup-bot | 3 | A bot for backing up your data | [https://recipes.coopcloud.tech/backup-bot](https://recipes.coopcloud.tech/backup-bot) |
| backup-bot-two | 3 | Another version of the backup bot | [https://recipes.coopcloud.tech/backup-bot-two](https://recipes.coopcloud.tech/backup-bot-two) |
| base-row | 3 | An open source no-code database tool | [https://recipes.coopcloud.tech/base-row](https://recipes.coopcloud.tech/base-row) |
| baserow | 3 | Open source no-code database tool | [https://recipes.coopcloud.tech/baserow](https://recipes.coopcloud.tech/baserow) |
| bonfire | 3 | A federated social network server | [https://recipes.coopcloud.tech/bonfire](https://recipes.coopcloud.tech/bonfire) |
| botamusique | 3 | A music bot for Discord | [https://recipes.coopcloud.tech/botamusique](https://recipes.coopcloud.tech/botamusique) |
| caddy | 3 | A powerful, enterprise-ready, open source web server | [https://recipes.coopcloud.tech/caddy](https://recipes.coopcloud.tech/caddy) |
| cal | 3 | A calendar and scheduling application | [https://recipes.coopcloud.tech/cal](https://recipes.coopcloud.tech/cal) |
| calibre-web | 3 | A web app for browsing, reading and downloading eBooks | [https://recipes.coopcloud.tech/calibre-web](https://recipes.coopcloud.tech/calibre-web) |
| capsul | 3 | A personal content archival system | [https://recipes.coopcloud.tech/capsul](https://recipes.coopcloud.tech/capsul) |
| civicrm-backdrop | 3 | A CRM for non-profits and other public-benefit organizations | [https://recipes.coopcloud.tech/civicrm-backdrop](https://recipes.coopcloud.tech/civicrm-backdrop) |
| civicrm-wordpress | 3 | A CRM for non-profits and other public-benefit organizations | [https://recipes.coopcloud.tech/civicrm-wordpress](https://recipes.coopcloud.tech/civicrm-wordpress) |
| collabora | 3 | Online Office suite | [https://recipes.coopcloud.tech/collabora](https://recipes.coopcloud.tech/collabora) |
| compy | 3 | A tool for comparing and synchronizing files and directories | [https://recipes.coopcloud.tech/compy](https://recipes.coopcloud.tech/compy) |
| container | 3 | A generic container recipe | [https://recipes.coopcloud.tech/container](https://recipes.coopcloud.tech/container) |
| croc | 3 | Easily and securely send things | [https://recipes.coopcloud.tech/croc](https://recipes.coopcloud.tech/croc) |
| cryptpad | 3 | A private-by-design collaborative editor | [https://recipes.coopcloud.tech/cryptpad](https://recipes.coopcloud.tech/cryptpad) |
| custom-html | 3 | A recipe for a custom HTML website | [https://recipes.coopcloud.tech/custom-html](https://recipes.coopcloud.tech/custom-html) |
| custom-html-tiny | 3 | A tiny recipe for a custom HTML website | [https://recipes.coopcloud.tech/custom-html-tiny](https://recipes.coopcloud.tech/custom-html-tiny) |
| custom-php | 3 | Custom PHP application | [https://recipes.coopcloud.tech/custom-php](https://recipes.coopcloud.tech/custom-php) |
| dashy | 3 | A self-hosted dashboard for your server | [https://recipes.coopcloud.tech/dashy](https://recipes.coopcloud.tech/dashy) |
| discourse | 3 | A platform for community discussion | [https://recipes.coopcloud.tech/discourse](https://recipes.coopcloud.tech/discourse) |
| distribution | 3 | A tool for distributing content | [https://recipes.coopcloud.tech/distribution](https://recipes.coopcloud.tech/distribution) |
| docker-hub-rss | 3 | An RSS feed for Docker Hub images | [https://recipes.coopcloud.tech/docker-hub-rss](https://recipes.coopcloud.tech/docker-hub-rss) |
...
| drone | 3 | A self-service Continuous Integration platform | [https://recipes.coopcloud.tech/drone](https://recipes.coopcloud.tech/drone) |
| drone-docker-runner | 3 | A runner for Drone that uses Docker | [https://recipes.coopcloud.tech/drone-docker-runner](https://recipes.coopcloud.tech/drone-docker-runner) |
| drutopia | 3 | A Drupal distribution for grassroots groups | [https://recipes.coopcloud.tech/drutopia](https://recipes.coopcloud.tech/drutopia) |
| element-web | 3 | A glossy Matrix collaboration client for the web | [https://recipes.coopcloud.tech/element-web](https://recipes.coopcloud.tech/element-web) |
...
| etherpad | 3 | A real-time collaborative editor | [https://recipes.coopcloud.tech/etherpad](https://recipes.coopcloud.tech/etherpad) |
...
| n8n | 3 | A free and open fair-code licensed node-based workflow automation tool | [https://recipes.coopcloud.tech/n8n](https://recipes.coopcloud.tech/n8n) |
...
| renovate | 3 | An automated dependency update tool | [https://recipes.coopcloud.tech/renovate](https://recipes.coopcloud.tech/renovate) |
...
| writefreely | 3 | A minimalist, federated blogging platform | [https://recipes.coopcloud.tech/writefreely](https://recipes.coopcloud.tech/writefreely) |
